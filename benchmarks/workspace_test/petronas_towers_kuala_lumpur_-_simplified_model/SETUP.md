...
# Setup Instructions for: Petronas Towers (Kuala Lumpur) - Simplified Model

## Overview
452 m twin towers with sky bridge; tuned mass damper, rectangular tube columns

Category: super-tall
Difficulty: medium

## Reference Data Sources
- Kar-Wai et al. 1998: Petronas Towers Design (CTBUH)
- Symonds & Harford 1998: Wind Tunnel Studies

## Expected Validation Outputs
- Tower fundamental frequency: ~0.20 Hz (±10%)
- Sky bridge connector force distribution
- Wind-induced acceleration limits (<0.25%g)
...
6. **Run Validation**
   ...
   - `python3 tools/validate_benchmark.py --benchmark petronas_towers_kuala_lumpur_-_simplified_model --workspace .`
...
## Notes
Focus on symmetric and coupled tower response; bridge interaction validation
