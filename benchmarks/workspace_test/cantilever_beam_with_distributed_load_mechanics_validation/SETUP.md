...
# Setup Instructions for: Cantilever Beam with Distributed Load (Mechanics Validation)

## Overview
Classic elasticity problem: cantilever beam, distributed load; analytical solution available

Category: validation-basic
Difficulty: trivial

## Reference Data Sources
- Timoshenko & Gere: Theory of Elastic Stability (analytical formulas)

## Expected Validation Outputs
- Max deflection within 1% of analytical (Wmax = 5qL^4/384EI)
- Support reaction within 0.1% of analytical (R = qL)
- Internal moment distribution shape (compare curvature)
...
6. **Run Validation**
   ...
   - `python3 tools/validate_benchmark.py --benchmark cantilever_beam_with_distributed_load_mechanics_validation --workspace .`
...
## Notes
Fundamental validation; if this fails, solver setup is wrong
